...
public class WelcomeDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.title(getString(R.string.dialog_welcome_title)).customView(view, true)
                .positiveText(getString(R.string.dialog_welcome_ok)).callback(new MaterialDialog.ButtonCallback() {
            @Override
